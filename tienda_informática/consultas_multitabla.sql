...
SELECT
    ...
    fabricante.nombre AS 'Fabricante'
FROM producto
JOIN fabricante ON codigo_fabricante = fabricante.id
...
FROM producto
JOIN fabricante ON producto.codigo_fabricante = fabricante.id
WHERE fabricante.nombre LIKE 'crucial' && producto.precio > 200;
...
FROM producto
JOIN fabricante ON producto.codigo_fabricante = fabricante.id
WHERE INSTR(fabricante.nombre, 'w');
...
SELECT DISTINCT
    ...
    fabricante.nombre
FROM fabricante
JOIN producto ON fabricante.id = producto.codigo_fabricante;

/*--------------------------- Consultas multitabla (composición externa) -------------------------------*/

--Resuelve las consultas utilizando las tablas LEFT JOIN y RIGHT JOIN
...
RIGHT JOIN fabricante ON producto.codigo_fabricante = fabricante.id;
